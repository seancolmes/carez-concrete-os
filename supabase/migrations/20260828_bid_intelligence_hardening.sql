...
select f.company_id,f.lead_id,f.id bid_price_feedback_id,f.competitor_name,f.competitor_price,
  f.feedback_source,f.scope_comparable,f.evidence_strength,f.safe_for_price_comparison,
