...
- repository validation passes `pnpm check`, including typecheck, the complete configured test suite (now including `tests/condition-repeatable-role-linkage.test.ts`), and the production build;
