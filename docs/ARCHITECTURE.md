...
Visual direction is governed by ADR-025 as revised by FINAL-2026-09-26: CAREZ STEAM SLEEK V28. Dark blue-charcoal workspaces, layered steel navigation, compact technical controls, thin borders, and accessible azure/cyan interaction replace the earlier dark/Indigo Harbor palettes. Source-owned shadcn/ui primitives and the shared Carez component pack remain one component system. Current Command Rail / Domain Deck / contextual Command Bar ownership supersedes older shell arrangements; presentation never owns quantity or financial authority.
